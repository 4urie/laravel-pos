        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    ...
                    <a href="{{ route('customers.trash') }}" class="btn btn-info add-list"><i class="fa-solid fa-recycle mr-3"></i>Recycle Bin</a>
                    <a href="{{ route('customers.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-magnifying-glass mr-3"></i>Clear Search</a>
                </div>
            </div>
        </div>
