                            ...
                            <div class="card card-block card-stretch card-height mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="style-text text-left mt-3">
                                        ...
                                        <p class="mb-0">Revenue: ₱{{ number_format($product->total_revenue, 2) }}</p>
                                        <p class="mb-0">Sold: {{ $product->total_quantity_sold }} units</p>
                                        <p class="mb-0">Stock: {{ $product->current_stock }} items</p>
                                    </div>
                                </div>
                            </div>
                        </li>
