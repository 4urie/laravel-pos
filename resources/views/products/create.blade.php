                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="0" step="0.01" class="form-control @error('buying_price') is-invalid @enderror" id="buying_price" name="buying_price" value="{{ old('buying_price') }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 46">
                                @error('buying_price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="0" step="0.01" class="form-control @error('selling_price') is-invalid @enderror" id="selling_price" name="selling_price" value="{{ old('selling_price') }}" required onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 46">
                                @error('selling_price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
